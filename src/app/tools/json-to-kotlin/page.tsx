...
import { generateKotlinCode } from "./generator";
        ...
        <>
            <div className="flex flex-wrap items-center justify-between gap-3 border-b border-white/10 p-1 pl-4">
                <div className="flex flex-col gap-1">
                    <h1 className="text-white text-2xl font-bold leading-tight tracking-[-0.033em]">JSON to Kotlin</h1>
                    <p className="text-white/60 text-sm font-normal leading-normal">Convert JSON to Kotlin data classes with serialization support.</p>
                </div>
            </div>
