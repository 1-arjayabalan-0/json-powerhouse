            ...
            <div className="max-w-4xl mx-auto px-6 py-12">
                ...
                <div className="space-y-8 text-muted-foreground leading-relaxed">
                    <section>
                        ...
                        <p className="mb-4">
                            Welcome to JSON PowerHouse. This Privacy Policy explains how we handle your data when you use our web-based JSON manipulation tools.
                        </p>
                        <p className="mb-4">
                            <strong className="text-foreground">TL;DR:</strong> We don't collect, store, or transmit any of your data. Everything happens locally in your browser.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="mb-4">JSON PowerHouse is a 100% client-side application. This means:</p>
                    ...
                    <section>
                        ...
                        <p className="mb-4">Because all processing happens in your browser, we do not collect:</p>
                        <ul className="space-y-2 ml-6 list-disc">
                    ...
                    <section>
                        ...
                        <p className="mb-4">JSON PowerHouse may use your browser's local storage to:</p>
                        <ul className="space-y-2 ml-6 list-disc">
                        ...
                        <p className="mt-4">
                            This data is stored locally on your device and is never transmitted to our servers or any third parties. You can clear this data at any time through your browser settings.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            The application is hosted on a web server, which may collect standard server logs (IP addresses, timestamps, requested URLs) for security and performance monitoring purposes. However, these logs do not contain any of your JSON data or usage information.
                        </p>
                    </section>

                    <section>
                        <h2 className="text-2xl font-bold text-foreground mb-4">Security</h2>
                        <p className="mb-4">Since all processing happens in your browser and no data is transmitted to servers:</p>
                        <ul className="space-y-2 ml-6 list-disc">
                    ...
                    <section>
                        ...
                        <p>
                            JSON PowerHouse does not knowingly collect any information from anyone, including children under 13. Since we don't collect any data at all, the service can be used by anyone without privacy concerns.
                        </p>
                    </section>

                    <section>
                        <h2 className="text-2xl font-bold text-foreground mb-4">Changes to This Privacy Policy</h2>
                        <p className="mb-4">We may update this Privacy Policy from time to time. When we do, we will:</p>
                        <ul className="space-y-2 ml-6 list-disc">
