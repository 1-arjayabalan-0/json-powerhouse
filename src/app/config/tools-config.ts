...
export const toolsConfig: ToolCategory[] = [
    ...
    },
    {
        ...
        icon: 'code',
        tools: [
            { id: 'json-to-typescript', name: 'JSON → TypeScript', path: '/tools/code/json-to-typescript', icon: 'javascript' },
            { id: 'json-to-java', name: 'JSON → Java', path: '/tools/code/json-to-java', icon: 'coffee' },
            { id: 'json-to-kotlin', name: 'JSON → Kotlin', path: '/tools/code/json-to-kotlin', icon: 'code' },
            { id: 'json-to-dart', name: 'JSON → Dart', path: '/tools/code/json-to-dart', icon: 'flutter_dash' },
            { id: 'json-to-swift', name: 'JSON → Swift Codable', path: '/tools/code/json-to-swift', icon: 'code' },
            { id: 'json-to-go', name: 'JSON → Go Struct', path: '/tools/code/json-to-go', icon: 'code' },
